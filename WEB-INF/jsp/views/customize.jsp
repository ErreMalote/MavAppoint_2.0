...
<div class="container">
	<p>
		<a href="#" data-toggle="modal" data-target="#addApptType">Customize
			Appointments</a>
	<div class="container">
		<div class="btn-group">
			<form action="appointments" method="post" name="cancel">
				...
				<div class="row col-md-16  custyle">
					<table class="table table-striped custab">
						<thead>
							<tr>
								<th><font style="color: #e67e22" size="4">Appointment
										Type</th>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="addApptTypeLabel">Add Appointment
							Type</h4>
					</div>
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="minutes">Minutes</label> <input type="number"
								class="form-control" id="minutes" step="5" placeholder="15">
						</div>
						<div>
